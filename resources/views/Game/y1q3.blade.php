<html lang="en"><head>
  ...
  <title>Game-Bot Year 1 Quarter 3</title>
...
#computeTS .textoverimg1 {line-height: 1.2;}
    ...
    <div class="modal-dialog modal-dialog-centered mt-0">
      <div class="modal-content borderornage mt1">
        ...
        <div class="modal-body pt-0 pb-0">
          <div id="imgset1" class="row d-flex mb-ads">
            <div id="col-card1" class="col-md-6 col-card1">
              <img id="image1" class="img" src="@if(isset($event_card_selected)) {{$event_card_selected->card_image}}  @else Media/Image/eventQ3/q3event.svg @endif" alt="">
                    ...
                    <label class="stock-img">
                      ...
                      <input type="radio" name="optn" value="{{$data->card_invest}}"
                       @if(isset($event_card_selected) && $event_card_selected->card_name == $data->card_name) checked default  @else
                        @if(isset($event_card_selected) )  @else onclick="selectbtn()" @endif @endif id="event_card_{{$data->card_id}}_Y1Q3"  >
                      <div class="stock1">
        ...
        <div  @if(isset($event_card_selected)) @else id="oknext" @endif  class="modal-footer noborder dcenter mt-2 footerbtn">
          <button class="btnstyle" type="button" @if(isset($event_card_selected)) onclick="openNext('#Matrixbox','#Backdop2')" @else  @endif style="border: none;"><img src="Images/Ok button.svg" alt="" width="50%"></button>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="col-12">
                <div class="d-flex justify-content-center">
                  ...
                  <div class="row text1">
                    ...
                    <div class="col-12 rec_amount"><p><span id="ReceivableAmt">{{ (isset($product_launch_val_2->acc_receivable) && $product_launch_val_2->acc_receivable != '') ? $product_launch_val_2->acc_receivable : 0}}</span>M</p></div>
                   </div>
                </div>
              </div>
...
<!-- Record Discount -->
      ...
      <tr>
        ...
        <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
          <input type="text" value="1" id="distotals" style="display:none" >
              <button class="btnstyle" type="button" data-bs-dismiss="modal" onclick="slider_('disTotalY1Q3','discount')" style="border: none;"><img src="Images/Ok button.svg" alt="" width="50%"></button>
            </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade modal-xy" id="cosrecord" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
    ...
    @if(array_sum($cos_value_1) != 0)
      ...
      <tr>
        ...
        <td><button type="button" class="btnamount"><span id="costotalYear1Q3">{{ (isset($product_launch_val_3->total_cos) && $product_launch_val_3->total_cos != '') ? $product_launch_val_3->total_cos : 0}}</span>M</button></td>
        <td><button type="button" class="btnamount">-</button></td>
      </tr>
    </tbody>
  </table>
  <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
  <input type="text" value="1" id="costotals" style="display:none" >
    <button class="btnstyle table_button"  type="button" onclick="slider_('costotalYear1Q3','cos')"  style="border: none;"><img src="Images/Ok button.svg" alt="" width="50%"></button>
  </div>    
  ...
  function slider_(input,output){
    ...
    if(output == 'cos'){
      var i = $('#costotals').val();
        if(i == 1){
          ...
          var my_var = @php echo json_encode($product_launch_val_3->final_cos_val); @endphp;
          // alert(my_var)
            if(my_var){
      ...
      var i = $('#tstotals').val();
        if(i == 1){
          ...
          $.ajax({
           ...
           dataType:"Json",
           data: {"trade_spend":val1,"acc_recei":val2,"customer_money":val3,"type":"product_launch_3"},
    ...
    if(output == 'accr'){
      var i = $('#rqnsokBtn').val();
        if(i == 1){
          var val1 = parseInt(document.getElementById(input).innerHTML);
          var val2 = (document.getElementById('accountrec').innerHTML);
          var val3 = parseInt(document.getElementById('custmoney').innerHTML);
    ...
    <div class="modal-dialog modal-dialog-centered mb-0 mt-0">
      <div class="modal-content borderornage mt1">
        ...
        <div class="modal-body pt-0 pb-0">
          ...
          <div class="row">
            ...
            @if(isset($product_launch_val_3->pf_cal) && $product_launch_val_3->pf_cal > 0)
            {{-- <h2>yv</h2> --}}
            <script>
              $(document).ready(function() {
                // alert('dsf')
                // setTimeout(()=>{
                  calSign('cosrecord1','comp1','cosrecord','product_launch_3','cos','view')   
                // },2000);
              });
      ...
      <!-- </div> -->
        <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
          ...
          <button id="comp1" class="btnstyle" type="button" onclick="Foo('cosrecord1','cosrecord','{{ $product_launch_val_3->card_type}}')" style="border: none;"><img src="Media/Image/RecCosBtn.svg" alt="" width="50%"></button>
        </div>
        </div>
      </div>
    </div>
  @elseif(isset($product_launch_val_3) && $product_launch_val_3->card_type == 'product_launch_3')
  {{-- <h2>Year 1 Q 3</h2> --}}
  <div class="col Store">
    <div class="row gx-0">
      <div class="col">
          ...
          <div class="col dcenter Scol1" id="">
            <div class="flip-card-inner">
              <div class="flip-card-front">
                ...
                @php                
                    $card_id   = DB::table('cards')->where('card_name',$prod_flag['key5']['0'])->first(); 
                    $product_flag_type = DB::table('gameflows')->where('card_type', '=', 'product_launch_3')->first();  
...
Select Product first
    ...
    <div class="modal-dialog modal-dialog-centered mb-0 mt-0">
      <div class="modal-content borderornage mt1">
        ...
        <div class="modal-body pt-0 pb-0">
          <div class="container">
          <div class="row">
            @if(isset($product_launch_val_3) && $product_launch_val_3->compute_sales > 0)
            <script>
              $(document).ready(function() {
              // setTimeout(()=>{
                calSign('computesale1','comp2','salerecord','product_launch_3','sales','view')    
              // },3000);
              });
            </script>
            {{-- <h2>sa</h2> --}}
            ...
            <div class="col-2 align-items-center Total" style="width: fit-content; display:flex">
              ...
              <div class="totaltxt" style="display:block">
                <div>TOTAL</div>
                <div><span class="crtotal">{{ $product_launch_val_3->compute_sales}}</span>M</div>
              </div>
            </div>
          </div>  
          </div>
          ...
          <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
           ...
           <button id="comp2" class="btnstyle" type="button" onclick="Foo('computesale1','salerecord','{{ $product_launch_val_3->card_type}}')" style="border: none;">
  ...
  <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
  <input type="text" @if(isset($product_launch_val_3->total_sales)) value="2" @else value="01" @endif id="salestotals" style="display:none" >
    <button class="btnstyle table_button" type="button" onclick="slider_('salesTotalY1Q3','sales')"  style="border: none;"><img src="Images/Ok button.svg" alt="" width="50%"></button>
    </div>    
</div>
</div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered mb-0 mt-0">
      <div class="modal-content borderornage mt1">
        ...
        <div class="modal-body pt-0 pb-0">
          <div class="container">
          <div class="row">
        @if(isset($product_launch_val_3) && $product_launch_val_3->compute_trade > 0)
          <script>
            $(document).ready(function() {
            // setTimeout(()=>{
              // alert('fsdf')
              calSign('computeTS','comp3','RTS','product_launch_3','ts','view')
            // },3000)
            });
        </script>
        <div class="col Store">
        ...
        <div class="col-2 align-items-center Total" style="width: fit-content; display:flex">
          ...
          <div class="totaltxt" style="display:block">
            <div>TOTAL</div>
            <div><span class="crtotal">{{ $product_launch_val_3->compute_trade}}</span>M</div>
          </div>
        </div>
      </div>  
      </div>
      ...
      <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
        {{-- <img class="recbtn" style="display: none;" src="Media/Image/RecSalebtn.svg" alt=""> --}}
       <button id="comp3" class="btnstyle" type="button" onclick="Foo('computeTS','RTS','{{ $product_launch_val_3->card_type}}')" style="border: none;">
        <img src="Media/Image/RecSalebtn.svg" alt="" width="50%"></button>
     </div>
      </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered mb-0 mt-0">
      <div class="modal-content borderornage mt1">
        ...
        <div class="modal-body pt-0 pb-0">
          <div class="container">
          <div class="row">
            @if(isset($product_launch_val_3) && $product_launch_val_3->compute_discount > 0)
            <script>
              $(document).ready(function() {
              // setTimeout(()=>{
                // alert('fsdf')
                calSign('computeDis','comp4','backdropa','product_launch_3','disc','view')
                // Foo('computeDis','backdropa','product_launch_3')
        ...
        <div class="col-2 align-items-center Total" style="width: fit-content; display:flex">
          ...
          <div class="totaltxt" style="display:block">
            <div>TOTAL</div>
            <div><span class="crtotal">{{ $product_launch_val_3->compute_discount}}</span>M</div>
          </div>
        </div>
      </div>  
      </div>
      ...
      <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
        {{-- <img class="recbtn" style="display: none;" src="Media/Image/RecSalebtn.svg" alt=""> --}}
       <button id="comp4" class="btnstyle" type="button" onclick="Foo('computeDis','backdropa','{{ $product_launch_val_3->card_type}}')" style="border: none;">
        <img src="Media/Image/RecSalebtn.svg" alt="" width="50%"></button>
     </div>
      </div>
      </div>
  ...
  <div class="modal fade modal-yy" id="RQNS" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <tbody>
      <tr>
        ...
        <td><button type="button" class="tardeamount" id="quarterly_sales_Y1Q2">{{(isset($product_launch_val_2->total_sales) && $product_launch_val_2->total_sales != '') ? $product_launch_val_2->total_sales : 'something went wrong'}} M</button></td>
        <td><button type="button" class="tardeamount" id="quarterly_sales_Y1Q3">{{(isset($product_launch_val_3->total_sales) && $product_launch_val_3->total_sales != '') ? $product_launch_val_3->total_sales : 'something went wrong'}} M</button></td>
        <td><button type="button" class="tardeamount">-</button></td>
      </tr>  
      <tr>
        <td class=""></td>
      ...
      <tr>
        ...
        <div id="" class="modal-footer noborder dcenter mt-2 footerbtn">
          <input type="text" value="1" id="rqnsokBtn" style="display:none" >
              ...
              @if(isset($product_launch_val_3->car_total) && $product_launch_val_3->car_total != '')  onclick="slider_('sales_n_dis','accr')"
              @else onclick="car_total('{{(isset($product_launch_val_3->card_type) ) ? $product_launch_val_3->card_type : ''}}')" 
              @endif 
      ...
      <div class="modal fade backblur" id="paytoSuppliers" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content nobg">
            ...
            <div class="ttpaybtn">
 <button type="button" id="pay_res" class="btn" @if(isset($product_launch_val_3->total_cos) && $product_launch_val_3->total_cos == 0)  @else onclick="pay_res()"  @endif></button>            </div>
...
@foreach ($product as $data)
      ...
      <?php 
          if(isset($product_launch_val_3->customer_money) &&  $product_launch_val_3->customer_money != ''){
...
<script src="{{ asset('js/custom.js')}}"></script>
  ...
  <script>
    ...
    function car_total(type){
      var quarterly_sales_Y1Q3 = parseInt(document.getElementById('quarterly_sales_Y1Q3').innerHTML); 
      var quarterly_discount_Y1Q3 = parseInt(document.getElementById('quarterly_discount_Y1Q3').innerHTML);
      var car_total = quarterly_sales_Y1Q3 - quarterly_discount_Y1Q3;
      // console.log(quarterly_discount_Y1Q3,quarterly_sales_Y1Q3,car_total)
      var accountrec  = (document.getElementById('accountrec').innerHTML); 
      var custmoney = parseInt(document.getElementById('custmoney').innerHTML); 
      console.log(quarterly_discount_Y1Q3,quarterly_sales_Y1Q3,car_total,custmoney,accountrec)
    ...
    function okbtn1() {
      ...
      if (Radiobtn1 != null) {
        ...
        if (a == 'A') {
          $("#image1").attr('src','Media/Image/eventQ3/Q3A-selected.svg');
           var image  = $('#image1').attr('src')
          selectOpt(a,image,div_id)          
          bE = {{$Events_cards_3['0']->be}}; esat = {{$Events_cards_3['0']->esat}}; GA = 0; RU= 0;
          var ce=0; sales= 0;
          setTimeout(function () {
            matrixT(csat=0,bE,esat,ce,div_id,sales,RU)
          },1000)
        }
        else if (a == 'B') {
          $("#image1").attr('src','Media/Image/eventQ3/Q3B-selected.svg');
           var image  = $('#image1').attr('src')
          selectOpt(a,image,div_id)          
          bE = {{$Events_cards_3['1']->be}}; esat = {{$Events_cards_3['1']->esat}}; sales=-4;
          var type =div_id;
          var ce=0;
          setTimeout(function () {
            matrixT(csat=0,bE,esat,ce,div_id,sales)
          },1000)

        }
        else if (a == 'C') {
          $("#image1").attr('src','Media/Image/eventQ3/Q3C-selected.svg');
           var image  = $('#image1').attr('src')
          selectOpt(a,image,div_id)          
          csat = {{$Events_cards_3['2']->csat}}; sales = -2; GA = 2; cash = 2;bE = {{$Events_cards_3['2']->be}};
          var ce=0; esat = {{$Events_cards_3['2']->esat}};
          g_a = {{$Events_cards_3['2']->ga_val}};
          console.log('c has ' + csat,bE,esat,ce,div_id,sales);
          setTimeout(function () {event_optnC(a,div_id,g_a)},200)
          setTimeout(function () {
      ...
      $("#oknext").attr('onclick','openNext('+"'#Matrixbox','#Backdop2',"+"'"+'q3optn'+a+"')");
    }
    ...
    function selectOpt(a,image,div_id){
      ...
      $.ajax({
            type: "get",
            url: "{{url('q2selectOpt_y1q3')}}",
           dataType:"Json",
           data: {a,image,div_id},
           
            success: function (response) {
                console.log(response);
                console.log('this is ru '+response.event_flow.ru_box_q3);

                if(a == 'A'){
                  var gnabox = parseInt(document.getElementById('qna_box').innerHTML);
                  var gna_val = parseInt(response.event_flow.gna_box_q3);
                document.getElementById('qna_box').innerHTML = (gnabox + gna_val);
                // ru_box_q3
                var rubox = parseInt(document.getElementById('rent_box').innerHTML);
                document.getElementById('rent_box').innerHTML = rubox + parseInt(response.event_flow.ru_box_q3);
                }
                else if(a == 'B'){
                  document.getElementById('eventq3').innerText = response.myevent.q3event_impact+' M';
                  document.getElementById('eventq4').innerText = response.myevent.q4event_impact+' M';

                  document.getElementById('salesEimpY3').innerText = response.myevent.q3event_impact+' M';
                  document.getElementById('salesEimpY4').innerText = response.myevent.q4event_impact+' M';

                }
                else if(a == 'C'){
                let gnabox = parseInt(document.getElementById('qna_box').innerHTML);
                document.getElementById('qna_box').innerHTML = gnabox + response.event_flow.gna_box_q3;
    ...
    function event_optnC(a,type,g_a){
    console.log(a,type,g_a);
      $.ajax({
            type: "get",
            url: "{{url('event_Y1Q3')}}",
           dataType:"Json",
           data: {a,type,g_a},
            ...
            success: function (response) {
                ...
                var gnaval = document.getElementById('qna_js').innerHTML;
                var new_gna = parseInt(gnaval) + parseInt(response.sales.invest_amount);
                document.getElementById('qna_js').innerHTML = new_gna;

                var option_c = (response.sales.total_coin);
                document.getElementById('cash1').innerHTML= option_c;
                document.getElementById('cash').innerHTML= option_c;
    ...
    function quarter3(){
  alert("quarter 4")
  window.open(window.location.href='QuarterY1Q4');
}
  ...
  function matrixT(cs,be,ee,ce,div_id,sales,GA,RU){
    console.log(cs,be,ee,ce,sales,GA,RU)
      ...
      var employee = parseInt(document.getElementById('employee').innerText);
      var collection =parseInt(document.getElementById('collection').innerText);
      console.log(customer_,brand, employee,collection,div_id)
  var Mx = ["customer_sta","brand", "employee", "collection"];
  ...
  var employee = parseInt(document.getElementById('employee').innerText);
  var collection =parseInt(document.getElementById('collection').innerText);
 console.log(customer_,brand, employee,collection);
      $.ajax({
                type: "get",
                url: "{{url('selectOpt_update_y1q3')}}",
              dataType:"Json",
              data: {customer_,brand, employee,collection,div_id,cs,be,ee,ce,sales,GA,RU},
                ...
                success: function (response) {
                  // if(response.sales_latesh.total_sales != ''){
                      ...
                      // document.getElementById('sales').innerHTML= parseInt(total);
                    // }
                    ...
                    // var add = cs + be + ce + ee;
                    // document.getElementById('eveImpYear1Q3').innerHTML =add;
    ...
    function Foo(id,open,type){
      ...
      if(B == '#cosrecord'){ document.getElementById('cosYear1Q3').innerHTML = abc;cosTableCal(type)}
      if(B == '#salerecord'){ document.getElementById('salesYear3').innerHTML = abc;saleTableCal(type) }
      if(B == '#RTS'){ document.getElementById('tradeSpendY1Q3').innerHTML = abc; tradespendTableCal()
        fillblink("compsalesblink","compTsblink");
       }
      if(B == '#backdropa'){ document.getElementById('disY1Q3').innerHTML =abc; recDisTableCal() }
    }


function cosTableCal(type){

  var eveImpY1Q3 = parseInt(document.getElementById('eveImpYear3').innerHTML);
  if(Number.isInteger(eveImpY1Q3)){
    eveImpY1Q3 = parseInt(document.getElementById('eveImpYear3').innerHTML);
  }
  else{
    eveImpY1Q3 = 0;
  }
  var stgImpY1Q3 = parseInt(document.getElementById('stgImpYear1Q3').innerHTML);
  if(Number.isInteger(stgImpY1Q3)){
    stgImpY1Q3 = parseInt(document.getElementById('stgImpYear1Q3').innerHTML);
  }
  else{
    stgImpY1Q3 = 0;
  }
  
  var costotal_3 = parseInt(document.getElementById('cosYear1Q3').innerHTML) + eveImpY1Q3 + stgImpY1Q3;
  document.getElementById('costotalYear1Q3').innerHTML = costotal_3;
  

  var costotalYear1Q2 = document.getElementById('costotalYear1Q3').innerText;  
      $.ajax({            
        type: "get",
...
function saleTableCal(type){
  ...
  var abc_sales = parseInt(document.getElementById('salesEimpY3').innerHTML);
  if(Number.isInteger(abc_sales)){
    abc_sales = parseInt(document.getElementById('salesEimpY3').innerHTML);
  }
  else{
    abc_sales = 0;
  }

  var strategy_sales = parseInt(document.getElementById('salesStrY3').innerHTML);
  if(Number.isInteger(strategy_sales)){
    strategy_sales = parseInt(document.getElementById('salesStrY3').innerHTML);
  }
  else{
    strategy_sales = 0;
  }

  var saletotal_3 = parseInt(document.getElementById('salesYear3').innerHTML) + abc_sales + parseInt(document.getElementById('salestradeSpendY1q3').innerHTML) + strategy_sales;
  document.getElementById('salesTotalY1Q3').innerHTML = saletotal_3;
  // alert(saletotal_3)

  var salesTotalY1Q2 =  parseInt(document.getElementById('salesTotalY1Q3').innerText);  
  ...
  document.getElementById('totalq1sales').innerHTML = saletotal_3;
}
function tradespendTableCal(){
  ...
  document.getElementById('salestradeSpendY1q3').innerHTML =  parseInt(document.getElementById('tradeSpendY1Q3').innerHTML);
...
function pay_res(){
  ...
  $.ajax({            
    ...
    url: "{{url('pay_res')}}",
   dataType:"Json",
   data: {"acc_pay":i,cashamt,ttl,"type":"product_launch_3"},           
    success: function (response) {
...
@if(isset($product_launch_val_3) && $product_launch_val_3->resources != '')
...
function payresources(){
  ...
  $.ajax({            
       ...
       dataType:"Json",
       data: {"resouce":10,"type":"resources_y1q3"},           
        success: function (response) {
          fillblink("finish_circle","parResblink");
            ...
            document.getElementById('resources').innerHTML = 30 ; 
            $('#res_val').val(2);
            slidetest('move-right','bottomcash');                              
          },
        error:function(error){
